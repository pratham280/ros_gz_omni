...
* `ros_gz_omni_description` - holds the sdf description of the simulated system and any other assets.

* `ros_gz_omni_gazebo` - holds gazebo specific code and configurations. Namely this is where systems end up.

* `ros_gz_omni_application` - holds ros2 specific code and configurations.

* `ros_gz_omni_bringup` - holds launch files and high level utilities.
...
1. Launch the simulation
    ...
    ```bash
    ros2 launch ros_gz_omni_bringup diff_drive.launch.py
    ```
