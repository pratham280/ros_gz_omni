 ...
 *
*/
#ifndef ros_gz_omni_GAZEBO__OMNIMATH_HH_
#define ros_gz_omni_GAZEBO__OMNIMATH_HH_
...
namespace ros_gz_omni_gazebo
{
  ...
  class OmniMath
  {
    ...
    /// velocity mean
    public: explicit OmniMath(size_t _windowSize = 10);
    ...
    public: bool Update(
      const gz::math::Angle &_frontLeftPos, const gz::math::Angle &_frontRightPos,
      const gz::math::Angle &_backLeftPos, const gz::math::Angle &_backRightPos,
      const clock::time_point &_time);

    /// \brief Get the heading.
    /// \return The heading in radians.
    public: const gz::math::Angle &Heading() const;
    ...
    public: const gz::math::Angle &AngularVelocity() const;
